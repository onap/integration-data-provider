...
PNF_VNF_INSTANTIATION_PARAMETERS_DATA = {
    ...
    "instantiation_parameters": [
        {"vnf_name": "test_vnf", "parameters": {"a": "b", "c": "d"}},
        {"pnf_name": "test_pnf", "instance_name": "test_pnf_instance"},
    ],
}
...
@patch(
    "onap_data_provider.resources.service_instance_resource.ServiceInstanceResource.service_subscription",
    new_callable=PropertyMock,
)
def test_test_service_instance_resource_vnf_and_pnf_instantiation(
    mock_service_subscription,
):
