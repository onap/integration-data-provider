...
class DataDictionarySetResource(Resource):
    ...
    def create(self) -> None:
        ...
        """
        if self.exists:
            self._data_dictionaries.upload()

    @property
    def exists(self) -> bool:
        """Determine if resource has been already loaded from file.

        Returns:
            bool: True if resource has been already loaded, fail otherwise.
        """
        return bool(self.data_dictionaries)
